...
(function () {
  const I18N = {
    en: {
      ...
      harmonyNavigatorSubtitle: 'Scales • Chord functions • Cadences • Key relationships',
      tonicLabel: 'Tonic',
      modeLabel: 'Scale / Mode',
      helpLabel: 'Quick Help',
      helpText: "Select tonic and mode. Below you'll see the scale, all diatonic chords with functions, popular cadences, and related keys with modulations.",
      ...
      categoryClose: 'Close relationship',
      categorySecondary: 'Secondary dominant',
      categoryModal: 'Modal relationship',
      categoryChromatic: 'Chromatic relationship',
      // Modulation strength
    ...
    ru: {
      ...
      harmonyNavigatorSubtitle: 'Гаммы • Функции аккордов • Каденции • Родственные тональности',
      tonicLabel: 'Тоника',
      modeLabel: 'Лад / Гамма',
      helpLabel: 'Справка',
      helpText: 'Выберите тонику и лад. Ниже появится гамма, все диатонические аккорды с функциями, список популярных каденций и родственные тональности с оборотами туда/обратно.',
      ...
      // Категории модуляций
      categoryClose: 'Близкое родство',
      categorySecondary: 'Вторичная доминанта',
      categoryModal: 'Модальное родство',
      categoryChromatic: 'Хроматическое родство',
      // Сила связи модуляций
