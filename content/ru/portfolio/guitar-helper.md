...
Данный раздел позволяет изучать гармонию, тональности и лады. Выбрав тональность, можно увидеть все аккорды и гаммы, которые к ней относятся. Каждый аккорд можно прослушать. Кроме того, можно прослушать распростанённые аккордовые прогрессии в выбранной тональности.
...
Данный [раздел](https://sixstringsapp.com/ru/scales-fretboard-explorer?root=E&mode=chord&display=intervals&chord=maj7&chordCat=seventh) помогает изучать гриф гитары. Выбирайте строй гитары и отображение нот или интервалов и изучайте аккорды и гаммы.
...
Увидели как гитарист играет аккорд, но не знаете как он называется? А может быть вы экспериментировали, нашли клёвый звук, но не знаете как записать, чтобы поделиться с друзьями? Введите ноты аккорда в [данный инструмент](https://sixstringsapp.com/ru/chord-identifier/) и узнайте его возможное название.

У проекта есть и другие возможности, которые помогут вам в изучении гитары. Вы можете попробовать их все на [официальном сайте](https://sixstringsapp.com/ru/).

А также есть [свой блог](https://sixstringsapp.com/ru/blog/) и [статьи по теории музыки](https://sixstringsapp.com/ru/theory/), которые помогут вам лучше понять музыкальные концепции и улучшить свои навыки игры на гитаре.
